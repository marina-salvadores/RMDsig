...
#run clustering
sigClusterScores = optimizeClustersPar(nmfHmatAllByFact, maxNumClusters = 20, threads = 10)
saveRDS(sigClusterScores, paste0("results/sig_matrix/NMF_sigClusterScores.Rda")) #'quality' of clustering(s), used to determine the number of signatures 
